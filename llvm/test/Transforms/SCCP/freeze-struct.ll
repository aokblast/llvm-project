...
; The undef member must stay frozen; the constant member is propagated.
define i32 @freeze_partial_undef_struct() {
; CHECK-LABEL: define i32 @freeze_partial_undef_struct() {
; CHECK-NEXT:    [[FR:%.*]] = freeze { i32, i32 } { i32 1, i32 undef }
; CHECK-NEXT:    [[B:%.*]] = extractvalue { i32, i32 } [[FR]], 1
; CHECK-NEXT:    call void @use(i32 [[B]])
; CHECK-NEXT:    ret i32 1
;
  %fr = freeze { i32, i32 } { i32 1, i32 undef }
...
define i32 @freeze_insertvalue_struct(i32 %x) {
; CHECK-LABEL: define i32 @freeze_insertvalue_struct(
; CHECK-SAME: i32 [[X:%.*]]) {
; CHECK-NEXT:    [[S1:%.*]] = insertvalue { i32, i32 } { i32 7, i32 undef }, i32 [[X]], 1
; CHECK-NEXT:    [[FR:%.*]] = freeze { i32, i32 } [[S1]]
; CHECK-NEXT:    [[B:%.*]] = extractvalue { i32, i32 } [[FR]], 1
; CHECK-NEXT:    call void @use(i32 [[B]])
; CHECK-NEXT:    ret i32 7
;
  %s0 = insertvalue { i32, i32 } poison, i32 7, 0
  %s1 = insertvalue { i32, i32 } %s0, i32 %x, 1
